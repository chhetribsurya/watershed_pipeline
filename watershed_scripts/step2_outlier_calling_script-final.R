...
main <- function(expr_file, rv_file, output_dir, pop) {
    ...
    finaloutfile_pval <- file.path(outdir, paste0("MAGE.", pop, ".Pvalthresbased.globalOutliersRemoved.txt"))
    ...
    finaloutfile_zscore <- file.path(outdir, paste0("MAGE.", pop, ".Zscorethresbased.globalOutliersRemoved.txt"))
