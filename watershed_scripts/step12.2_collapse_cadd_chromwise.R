...
#outfile1 ='/scratch16/abattle4/surya/datasets/WatershedAFR/data/annotation/cadd/gene-GLOBAL-rv.CADD.collapse.tsv'

# variant level annotation file
#outfile2 = "/scratch16/abattle4/surya/datasets/WatershedAFR/data/annotation/cadd/gene-GLOBAL-rv.CADD.uncollapsed.rvpair.tsv"
