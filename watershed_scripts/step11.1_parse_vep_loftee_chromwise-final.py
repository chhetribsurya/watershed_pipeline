...
def main():
    ...
    parser.add_argument(
        "--anno_prefix",
        required=True,
        help="Prefix of annotations from VEP and LOFTEE in vcf.gz format.",
    )
    parser.add_argument(
        "--outputfile",
        required=True,
    ...
    for vcf_file in glob.glob(f"{anno_prefix}.chr*.vep.loftee.vcf.gz"):
