...
process merge_annotations_and_sortN2pair {
    ...
    output:
        path "annotation_inputfinal/genelevel_output/${pop}/final-${pop}-rv.mergedannotation.thresbased.tsv", emit: merged_annotation_only
        path "annotation_inputfinal/genelevel_output/${pop}/final-${pop}-rv.mergedannotation.plusN2pair.thresbased.tsv", emit: merged_annotation_plusN2pair
        path "annotation_inputfinal/genelevel_output/${pop}/final-${pop}-rv.mergedannotation.plusN2pair.thresbased.stdscaled.tsv", emit: merged_stdscaled_annotation_plusN2pair
