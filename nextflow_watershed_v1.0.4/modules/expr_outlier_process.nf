...
process call_expr_outliers {
    ...
    output:
        ...
        path("rv_expoutlier_refbase/${pop}/*expoutlier.Zscorethresbased.reference.tsv"), emit: outlier_zscorethresh
        ...
        path("rv_expoutlier_refbase/${pop}/${pop}-pval_threshold.txt"), emit: pval_threshold_value
        path("rv_expoutlier_refbase/${pop}/${pop}-proportion_metric_zscore.txt"), emit: proportion_metric_zscore_value
        path("rv_expoutlier_refbase/${pop}/${pop}-proportion_metric_pval.txt"), emit: proportion_metric_pval_value
