...
process process_merged_annotations {
    ...
    output:
        path "processed_merged_annotation/${pop}/final-${pop}-rv.mergedannotation.plusN2pair.thresbased.stdscaled.annot.clean.tsv", emit: processed_file
        //path "processed_merged_annotation/${pop}/final-${pop}-rv.mergedannotation.plusN2pair.thresbased.annot.clean.tsv", emit: processed_file
    ...
    script:
        ...
        def output_file = "$outputdir/final-${pop}-rv.mergedannotation.plusN2pair.thresbased.stdscaled.annot.clean.tsv"
        //def output_file = "$outputdir/final-${pop}-rv.mergedannotation.plusN2pair.thresbased.clean.tsv"
