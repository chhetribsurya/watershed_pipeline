...
nextflow run ./main.nf -c nextflow.config \
  ...
  --tpm_infile "/scratch16/abattle4/surya/datasets/project_watershed/nextflow_pipe/test-scripts/data/kgpex.sample.unfiltered.tpm.tab" \
  --readcount_infile "/scratch16/abattle4/surya/datasets/project_watershed/nextflow_pipe/test-scripts/data/kgpex.sample.unfiltered.pseudocounts.tab" \
  --covariate_infile "/scratch16/abattle4/surya/datasets/project_watershed/nextflow_pipe/test-scripts/data/eQTL.covariates.tab.gz" \
  --subjids_file "/scratch16/abattle4/surya/datasets/project_watershed/nextflow_pipe/test-scripts/data/split_pops/AMR_ids.txt" \
  --rv_file "/scratch16/abattle4/surya/datasets/project_watershed/nextflow_pipe/test-scripts/data/1KGP_731-samples_all.filtered.phased.vcf.gz" \
  --tissue "LCL" \
  ...
  #--outlier_method "pvalue" \
  #--enrichment_method "zscore" \
  #--enrichment_method "pvalue" \
  #--enrichment_method "both" \
  #--aupr_plots "false" \
  #--cohort_name GTExEUR_zscorebased_4 \
  #--covariate_infile "/scratch16/abattle4/surya/datasets/project_watershed/nextflow_pipe/test-scripts/data/eQTL.covariates.tab.gz" \
