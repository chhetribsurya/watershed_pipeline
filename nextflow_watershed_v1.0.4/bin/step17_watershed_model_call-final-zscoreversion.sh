...
echo -e "\nZscore based method Pvalue threshold for watershed: $pval_threshold"
...
echo -e "\nCMD: Rscript ./predict_watershed.R --training_input $input_file --prediction_input $input_file --number_dimensions $number_of_dim --output_prefix $output_prefix --model_name $model --binary_pvalue_threshold $pval_threshold"
Rscript ./predict_watershed.R --training_input $input_file --prediction_input $input_file --number_dimensions $number_of_dim --output_prefix $output_prefix --model_name $model --binary_pvalue_threshold $pval_threshold
