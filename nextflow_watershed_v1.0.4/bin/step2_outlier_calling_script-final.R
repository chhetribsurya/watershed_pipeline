...
main <- function(expr_file, rv_file, output_dir, pop) {
    ...
    # Save other files
    outfile1 <- file.path(outdir, paste0(pop, "-pval_threshold.txt"))
    write(pval_threshold, file = outfile1)
    outfile2 <- file.path(outdir, paste0(pop, "-proportion_metric_zscore.txt"))
    write(proportion_metric_zscore, file = outfile2)
    outfile3 <- file.path(outdir, paste0(pop, "-proportion_metric_pval.txt"))
    write(proportion_metric_pval, file = outfile3)
