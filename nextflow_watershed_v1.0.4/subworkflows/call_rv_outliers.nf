...
workflow CALL_OUTLIERS {
    ...
    if (params.analysis == "GLOBAL") {
        ...
        // Conditional assignment of the output based on params.outlier_method
        if (params.outlier_method == "pvalue") {
            outlier_file_ch = call_expr_outliers.out.outlier_removed_pval
            outlier_refbasefile_ch = call_expr_outliers.out.outlier_pvalthresh
        } else if (params.outlier_method == "zscore") {
            outlier_file_ch = call_expr_outliers.out.outlier_removed_zscore
            outlier_refbasefile_ch = call_expr_outliers.out.outlier_zscorethresh
        } else {
            error "Invalid outlier method specified: ${params.outlier_method}. Valid options are 'pvalue' or 'zscore'."
        }
    ...
    pvalthresh_numeric_file  = call_expr_outliers.out.pval_threshold_value
    outlier_pval_file  = call_expr_outliers.out.outlier_removed_pval
    outlier_zscore_file  = call_expr_outliers.out.outlier_removed_zscore
