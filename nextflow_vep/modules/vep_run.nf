...
process VEP_RUN {
    ...
    tag { "JOB ${vcf_file}" }
    publishDir path: "${params.resultoutdir}/vep", pattern: "sQTL*", mode : 'copy'
    //publishDir path: "${params.resultoutdir}/vep", pattern: "query*", mode : 'copy'
    ...
    output:
       path("sQTL*"), optional: true, emit: all
       path("sQTL*.vcf"), optional: true, emit: vcf
       path("sQTL*.html"), optional: true, emit: html
       //path("query*"), optional: true, emit: all
       //path("query*.vcf"), optional: true, emit: vcf
       //path("query*.html"), optional: true, emit: html
