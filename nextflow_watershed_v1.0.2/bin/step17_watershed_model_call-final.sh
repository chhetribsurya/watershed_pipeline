...
#Rscript evaluate_watershed.R --input $input_file --number_dimensions $number_of_dim --output_prefix $output_prefix --model_name $model --n2_pair_pvalue_fraction 0.009
...
#Rscript $watershed_codedir/evaluate_watershed.R --input $input_file --number_dimensions $number_of_dim --output_prefix $output_prefix --model_name $model --binary_pvalue_threshold 0.00035
...
#Rscript $watershed_codedir/evaluate_watershed.R --input $input_file --number_dimensions $number_of_dim --output_prefix $output_prefix --model_name $model --binary_pvalue_threshold 2.535111e-06
Rscript ./evaluate_watershed.R --input $input_file --number_dimensions $number_of_dim --output_prefix $output_prefix --model_name $model --binary_pvalue_threshold 2.535111e-06
...
#Rscript $watershed_codedir/predict_watershed.R --training_input $input_file --prediction_input $input_file --number_dimensions $number_of_dim --output_prefix $output_prefix --model_name $model --binary_pvalue_threshold 2.535111e-06
Rscript ./predict_watershed.R --training_input $input_file --prediction_input $input_file --number_dimensions $number_of_dim --output_prefix $output_prefix --model_name $model --binary_pvalue_threshold 2.535111e-06
