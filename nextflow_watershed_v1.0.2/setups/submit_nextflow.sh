...
#mkdir -p /scratch16/abattle4/surya/datasets/for_scripts/project_watershed/nextflow_pipe/test-scripts/cache/singularitycache-test/tmp
#chmod -R 777 /scratch16/abattle4/surya/datasets/for_scripts/project_watershed/nextflow_pipe/test-scripts/cache/singularitycache-test
#export SINGULARITY_TMPDIR=/scratch16/abattle4/surya/datasets/for_scripts/project_watershed/nextflow_pipe/test-scripts/cache/singularitycache-test/tmp
#nextflow run main.nf -profile conda -process.echo
#nextflow run main.nf -profile conda,singularity -process.echo
